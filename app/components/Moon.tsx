...
const Moon = () => {
  // Initialisation des étoiles directement dans le state
  ...
  return (
    <svg viewBox="0 0 1200 1200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <g id="star">
      ...
      <g id="moon">
        ...
        {/* Ombre */}
        <circle cx="650" cy="500" r="190" fill="#F1DEA3" clipPath="url(#moonClip)" />
        {/* Cratères */}
